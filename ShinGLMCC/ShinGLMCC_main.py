...
if __name__ == "__main__":
    ...
    DATAID = sys.argv[1]
    MODE = sys.argv[2]    # Estimation method: "Shin" or "GLM"
    ...
    dfccK = pd.read_pickle(f"{DATAID}_cor_K.pkl")
    dfccJ = pd.read_pickle(f"{DATAID}_cor_J.pkl")
    print(f"Correlation data loaded for resolutions 0.1ms and 1ms")

    # Evaluate ShinGLMCC with no connection and save parameters and likelihood
